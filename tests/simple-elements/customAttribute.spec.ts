...
import { CustomAttribute } from '../../pages/simple-elements';

test.describe(
  'Elements with custom attribute - pw-test',
  { tag: ['@practice', '@gui'] },
  () => {
    let simpleElementsPage: CustomAttribute;

    test.beforeEach(async ({ page }) => {
      simpleElementsPage = new CustomAttribute(page);
